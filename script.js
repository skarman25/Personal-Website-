...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.vision-card, .issue-item, .stat-item, .contact-item');
...
document.querySelectorAll('.btn').forEach(button => {
    button.addEventListener('click', function() {
        if (this.type === 'submit' || this.href.includes('#')) {
            return; // Don't add loading for submit buttons or anchor links
        }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Add hover effect to issue items
...
console.log('Skarman Campaign Website - Building a Better Bangladesh');
